...
- `GET /health`
- Machine callers of protected APIs must follow the [Service Identity Consumer Standard](../auth-microservice/docs/SERVICE_IDENTITY_CONSUMER_STANDARD.md).
...
- Machine authentication is defined only by the [Service Identity Consumer Standard](../auth-microservice/docs/SERVICE_IDENTITY_CONSUMER_STANDARD.md).
