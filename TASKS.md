...
- TG-3.6 Goal 13 lifecycle journey engine (pending)
- TG-3.7 Goal 14 landing page and auth entry points (pending)
- TG-3.8 Goal 15 admin auth and RBAC shell (pending)
- TG-3.9 Goal 16 campaign and segment admin console (pending)
- TG-3.10 Goal 17 runs, consent, channels, and audit admin views (pending)
- TG-3.11 Goal 18 analytics and attribution dashboard (pending)
- TG-3.12 Goal 19 CRM/account service integration (pending)
- TG-3.13 Goal 20 production governance and readiness (pending)
