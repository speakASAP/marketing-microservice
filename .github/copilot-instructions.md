# Copilot Instructions — `marketing-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/marketing-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/marketing-microservice.git`, branch `main`.
